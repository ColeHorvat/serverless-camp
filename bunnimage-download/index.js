...
module.exports = async function (context, req) {
    ...
    let download = ""
    let downloadpng = "https://colecampstorage.blob.core.windows.net/images/" + username + ".png";
    let downloadjpg = "https://colecampstorage.blob.core.windows.net/images/" + username + ".jpeg";
    let success = true
